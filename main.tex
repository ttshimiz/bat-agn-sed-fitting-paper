...
\end{tabular}
\begin{tablenotes}
\item Notes -- \textit{Column 1:} Name of the source. \textit{Column 2:} Log of the dust mass in solar units. \textit{Column 3:} Dust temperature for the MBB component. \textit{Column 4:} Log of the powerlaw component normalization. \textit{Column 5:} Slope of the powerlaw component. \textit{Column 6:} Turnover wavelength. \textit{Column 7:} Log of the total infrared luminosity from 8--1000 \um{} in solar units. \textit{Column 8:} Log of the MBB component luminosity in solar units. \textit{Column 9:} Log of the powerlaw component luminosity in solar units. \textit{Column 10:} Fractional contribution of the AGN to the total infrared luminosity calculated using Equation~\ref{eq:c12_lum}. The full version of this table is available in the online publication.
\end{tablenotes}
\end{threeparttable}
\end{table}
\end{landscape}
