...
\end{align}
 ...
 The uncertainty on the correction factor leads to an uncertainty on $f_{\rm AGN}$ using this method which we estimate by measuring $f_{\rm AGN}$ for the combined HRS and KINGFISH sample. Figure~\ref{fig:fagn_nonAGN} shows the distribution of $f_{\rm AGN}$ for our non-AGN sample. As expected the distribution is centered around 0. We estimate the spread of the distribution by calculating the standard deviation, finding an uncertainty of 0.1. We apply 0.1 as the minimum error on $f_{\rm AGN}$  as well as the minimum $f_{\rm AGN}$ we can measure. Any $f_{\rm AGN}$ below 0.1 are converted to upper limits with a value of 0.1. 
...
\begin{figure*}
\includegraphics[width=0.8\textwidth]{figures/lir_total-comparison}
...
\begin{figure*}
\includegraphics[width=0.8\textwidth]{figures/agn_frac-comparison}
...
Before comparing the \herschel-BAT sample to our comparison non-AGN samples, we test our SED decomposition and measurements of $L_{\rm AGN,IR}$ and $L_{\rm SF}$ with other indicators of the AGN luminosity and star-formation. Specifically, we compare $L_{\rm AGN,IR}$ with the 14--195 keV luminosity and $L_{\rm SF}$ with the 11.3 and 7.7 polycyclic aromatic hydrocarbon (PAH) luminosity.
...
\caption{Correlation between $L_{\rm AGN, IR}$ and $L_{\rm 14-195\,keV}$ for the \herschel-BAT sample (blue points). The solid black line shows the result of Bayesian linear regression with the grey shaded region indicating the 95 per cent confidence interval. The strong correlation between the two luminosities provides evidence our SED decomposition performed well in measuring the IR luminosity associated with AGN heated dust.\label{fig:lagnIR_lbat}}
\end{figure}
...
We plot the best fit linear regression for the whole sample in Figure~\ref{fig:lagnIR_lbat} as a black line with grey shading to indicate the 95 per cent confidence interval. The best-fit line corresponds to the following relationship:

\begin{equation}\label{eqn:lagnIR_lbat}
\log(L_{\rm AGN,IR} =  (0.75\pm0.05)\log(L_{\rm 14-195\,keV}) + (11.1\pm2.3)
\end{equation}
...
The correlation coefficient from \textsc{linmix\_err} is $0.76\pm0.03$ and the intrinsic scatter is 0.13 dex. Our measured slope of 0.75 is significantly flatter than the slope measured in \citet{Gandhi:2009kx} ($m=1.1$) using sub-arcsecond 12 \micron{} imaging for 16 nearby Seyferts. However, given our very simple method for determining the AGN MIR luminosity from broadband SED decomposition, a slope near 1.0 and high correlation coefficient provides confidence that the decomposition has performed reasonably well. Further, Equation~\ref{eqn:lagnIR_lbat} will provide future studies with estimates of the full 8--1000 \micron{} AGN contribution and allow better estimates of IR-based SFRs for AGN.

\subsection{Comparison of $L_{\rm SF}$ with PAH measurements}
To test our estimates of the star-forming luminosity ($L_{\rm SF}$), we compare them with estimates of the star-forming luminosity calculated from the PAH 11.3 and 7.7 \micron{} luminosity. PAH features are thought to caused by the vibrations of complex hydrocarbons \citep{Draine:1984fk, Puget:1989lr} and have been shown to be reliable tracers of the SFR \citep{Roussel:2001kx, Sargsyan:2009fj, Treyer:2010uq, Shipley:2016qy} even for AGN \citep{Diamond-Stanic:2010kl}. Therefore, comparing our $L_{\rm SF}$ with the 11.3 and 7.7 \micron{} PAH luminosity provides a further check on our SED decomposition. 
...
Figure~\ref{fig:lsf_lpah} shows the correlation between $L_{\rm SF}$ and $L_{\rm PAH}$ for both the 7.7 (right) and 11.3 \micron{} complexes. We include as well the the measurements for the KINGFISH galaxies (red squares) where $L_{\rm SF}$ is from this work and $L_{\rm PAH}$ is from \citet{Smith:2007lr}. The $L_{\rm PAH}$ for KINGFISH were measured using PAHFIT, but given the large similarity with our method, we do not expect large differences.

We find good agreement between the relationship of $L_{\rm SF}$ and $L_{\rm PAH}$. Both the KINGFISH and \herschel-BAT samples follow broadly the same correlation indicating we are neither over nor under estimating $L_{\rm SF}$ from our SED decomposition for the \herschel-BAT AGN. For reference we also display the SFR-$L_{\rm PAH}$ relationship from \citet{Shipley:2016qy} where we have converted their SFR to $L_{\rm SF}$ using the following equation from \citet{Murphy:2011rt}:
...
\caption{Relationship between different IR colors and the $f_{\rm AGN}$, the fraction of the 8--1000 \micron{} luminosity attributed to AGN heated dust. The IR colors (x-axis) are in logarithmic units. We find that the colors involving the 160 \micron{} flux show the strongest correlation coefficients and are the best predictor for $f_{\rm AGN}$. We also display the 25th, 50th, and 75th percentile color for the \herschel-BAT AGN as dashed and solid lines.\label{fig:agnfrac_vs_flux_ratio}}
\end{figure*}
...
\midrule
12/70      & $0.51\pm0.03$ & $0.96\pm0.03$ & $0.017\pm0.002$ & $0.82\pm0.03$ & -1.23 (90) & -0.97 (50) & -0.66 (21)\\
12/160    & $0.46\pm0.02$ & $0.97\pm0.02$ & $0.004\pm0.002$ & $0.95\pm0.02$ & -1.51 (31) & -1.21 (5.2) & -0.85 (2.2)\\
12/250    & $0.33\pm0.03$ & $0.77\pm0.02$ & $0.017\pm0.003$ & $0.75\pm0.04$ & -1.22 (28) &  -0.91 (5.2) & -0.57 (1.5)\\
22/70      & $0.64\pm0.03$ & $0.82\pm0.02$ & $0.011\pm0.002$ & $0.89\pm0.02$ & -0.89 (32) & -0.60 (16) & -0.32 (12)\\
22/160    & $0.46\pm0.02$ & $0.80\pm0.02$ & $0.002\pm0.001$ & $0.97\pm0.02$ & -1.14 (5.6) & 0.83 (1.2) & -0.45 (0)\\
22/250    & $0.32\pm0.03$ & $0.64\pm0.02$ & $0.017\pm0.003$ & $0.75\pm0.05$ & 0.87 (6.8) & -0.51 (0.02) & -0.18 (0) \\
\bottomrule
\end{tabular}
\end{threeparttable}
\end{table*}
...
\subsection{The connection between nuclear activity and global star formation}
...
Figure~\ref{fig:sfr_lbat_correlation} plots the correlation between the SFR and $L_{\rm 14-195 keV}$ for the \herschel-BAT AGN. As before, blue colors indicate Type 1 AGN and red colors indicate Type 2 AGN.  We overplot several relationships from the literature for $z\sim0$ AGN including the expected relationship based on the variability model from \citet{Hickox:2014yq} (black dashed line), the observed relationship from \citet{Rosario:2012fr} based on \textit{IRAS} data of the BAT AGN (green solid line), and the observed relationship from \citet{Netzer:2009lr} (green dashed line) based primarily on AGN-dominated Type 2s from SDSS and their \textit{IRAS} 60 \micron{} luminosity.

For the \herschel-BAT sample, we fit the SFRs and 14--195 keV luminosity with the following linear model:

\begin{equation}
\log {\rm SFR} = m\log L_{\rm 14-195\,keV} + b + \epsilon_{\rm int}
\end{equation}

\noindent using \textsc{LINMIX} as before.  To see if there are differences in the relationship between Type 1s and Type 2s, we tested the correlation using the whole \herschel-BAT sample, only Type 1s, and only Type 2s. In Figure~\ref{fig:sfr_lbat_correlation}, the black line and shaded region represents the best-fit line and 95 percent confidence interval for the whole sample while the blue and red lines and shaded regions represent the relationship for Type 1s and Type 2s respectively. In Table~\ref{tab:lbat_sfr_correlation}, we outline the best fit slope, intrinsic scatter, and correlation coefficient and their uncertainties, determined by calculating the median and standard deviation of the posterior probability distributions. 

%%%%%%%%%%%%%%%%%%%%%%% FIGURE: Correlation Between LBAT and SFR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}
\includegraphics{figures/sfr_lbat_correlation}
\caption{Correlation between AGN luminosity as probed by $L_{\rm 14-195\,keV}$ and SFR. Error bars on $L_{\rm14-195\,keV}$ correspond to the 90 percentile confidence interval from the 58 month BAT catalog. Error bars on the SFR correspond to the 68 percentile confidence interval from our SED fitting. Downward pointing triangles plot 95 percent confidence upper limits on the SFR. Blue colors represent Type 1 AGN while red colors represent Type 2 AGN. The solid lines with shading plot the best fit lines and 95 percentile confidence interval from \textsc{linmix\_err}. No strong relationship exists between the AGN strength and global star formation. A color version of this figure is available in the online publication.\label{fig:sfr_lbat_correlation}}
\end{figure*}
...
Our measured AGN-SFR relationship agrees mainly with the previous studies that found a flat or weak relationship \citep{Silverman:2009lq, Diamond-Stanic:2012rw, Mullaney:2012gf, Azadi:2015ve, Stanley:2015qy}. The scatter in the relationship is high covering nearly 2 orders of magnitude in SFR for a given AGN luminosity. Two different but not mutually exclusive explanations have been proposed to explain the lack of relationship seen between the strength of the AGN and SFR. \citet{Diamond-Stanic:2012rw} suggest that the AGN only influences star formation in the nuclear regions of galaxies and find that when restricting their measurements to only the inner 1kpc, a stronger relationship appears. \citet{Esquej:2014vl}, probing even smaller scales ($r < 100$ pc) using MIR interferometry, also found a nearly linear relationship between the nuclear SFR and SMBH accretion rate, and  \citet{LaMassa:2013hb}, cleverly utilizing the fixed aperture of the SDSS fiber, found that only within 1.7 kpc a positive relationship between the SFR and accretion rate occurs (although the slope of their relationship is closer to our sublinear one compared to both \citet{Diamond-Stanic:2012rw} and \citet{Esquej:2014vl}). These are all in agreement with hydrodynamical simulations \citep{Hopkins:2010kx, Thacker:2014pd} that predict an increasingly linear relationship as the star formation size scale decreases. Work is currently ongoing to spatially decompose the SFRs of the \herschel-BAT sample to determine whether the relationship strengthens near the nucleus. %It could also explain the small differences we see when splitting the sample up by the location on the main sequence. If the BMS AGN have reduced star formation only on large scales, while the NMS have larger amounts of extended star formation, then our measurements would naturally be exploring different sizes. The reduced sizes in the BMS AGN would imply a stronger relationship, exactly what we observe in Figure~\ref{fig:sfr_lbat_correlation_ms}. Measurement of the FIR sizes and morphologies will be the subject of a future publication and we will explore the hypothesis that the star-forming region size is dependent on location with respect to the main sequence.
...
\end{figure*}
%\input{sed_figures.tex}

%\section{Table of Best Fit Parameters}
%\input{tables/bat-agn-c12-parameters_full.tex}
